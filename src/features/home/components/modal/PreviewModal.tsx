...
const PreviewModal = ({ url, onClose }: PreviewModalProps) => {
    ...
    return (
        <div
            className="fixed inset-0 bg-black/40 cursor-pointer flex items-center justify-center z-50 px-4"
            onClick={onClose}
        >
            <div
                className="bg-white w-full max-w-md relative rounded-xl shadow-2xl flex flex-col overflow-hidden"
            ...
            >
                ...
                <div className="bg-gradient-to-r from-orange-500 to-yellow-400 text-white text-center py-6 relative">
                    ...
                    <h2 className="text-xl font-bold px-4">📢 AVISO IMPORTANTE SOBRE EL CONCURSO PROCOMPITE TAMBOPATA 2025</h2>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-xs mt-2 text-end">Tamboapta, 15 de octubre de 2025</p>
                            </div>
                        </div>
                    </a>
                </div>
