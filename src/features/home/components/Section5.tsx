  ...
  return (
    <section className="py-16 bg-gradient-to-b from-white via-orange-200 to-white  mt-10">
      <div className="max-w-7xl mx-auto px-4">
        {/* Título */}
        <h2 className="text-4xl text-center text-green-600 font-bold mb-12 tracking-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-10">
          {winners.map((winner, index) => (
            <div
              ...
              className={`cursor-pointer border rounded-2xl p-6 shadow-sm transition-all duration-300 flex flex-col items-center text-center hover:shadow-xl hover:scale-[1.03] ${
                selectedWinner.name === winner.name
        ...
        <div className="bg-white border border-yellow-400 rounded-2xl shadow-xl p-6 md:p-10 flex flex-col md:flex-row gap-6 items-center md:items-start">
          ...
          <div>
            ...
            <p className="italic text-green-600 mb-3">
              <strong>CUI:</strong> {selectedWinner.cui}
            </p>
